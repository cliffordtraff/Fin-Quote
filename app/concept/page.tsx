...
export default function ConceptChartPage() {
  ...
  // Keep the server and first client render deterministic. Placeholder candles
  // are generated by the timeframe effect after hydration.
  const [adCandles, setAdCandles] = useState<ADCandle[]>([])
  ...
  const [nyseCandles, setNyseCandles] = useState<ADCandle[]>([])
