...
export const goldenSet: EvalTestCase[] = [
  {
 ...
 * Get test case by ID
 */
export function getTestCase(id: string): EvalTestCase | undefined {
 ...
 */
export function getTestCasesByTicker(ticker: string): EvalTestCase[] {
