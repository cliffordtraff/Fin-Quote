 ...
 */
export const formatDividendYield = (
  ...
  return yieldValue?.toFixed(2) || "0.00";
};

/**
 * Formats ex-dividend date for display
 */
export const formatExDividendDate = (date?: string | null): string => {
  if (!date) return "—";
 ...
 */
export const formatPercentChange = (change?: number | null): string => {
