 ...
 */
export function canonicalizeTopic(topic: string): Topic | null {
 ...
 */
export function canonicalizeTopics(topics: string[], maxTopics: number = 3): Topic[] {
 ...
 */
export const FEED_TOPIC_MAP: Record<string, Topic> = {
  // WSJ
  'wsj_markets': 'Markets',
 ...
 */
export function getFeedTopic(source: string, feedType: string): Topic {
