 ...
 */
export function transformFMPToTradingView(fmpData) {
    return fmpData
        .map((candle) => ({
 ...
 */
export function getDefaultLookback(timeframe) {
    const lookbackDays = {
 ...
 */
export function calculateCandleTimeframe(timestamp, timeframe) {
 ...
 */
export function mergeQuoteIntoCandle(currentCandle, quote, timeframe) {
 ...
 */
export function getChartCacheTTL(timeframe) {
    const ttlMap = {
        '1m': 60, // 1 minute
        '5m': 5 * 60, // 5 minutes
 ...
 */
export function isExtendedHours(timestamp) {
 ...
 */
export function filterRegularHoursOnly(data) {
