 ...
 */
export function validateWhyItMoved(data, ticker) {
    const errors = [];
    const warnings = [];
    // Type guard
 ...
 */
function validateSentimentScoreAlignment(sentiment, score) {
    switch (sentiment) {
        case 'bullish':
 ...
 */
export function generateFallback(ticker, priceChange, priceChangePercent, price) {
