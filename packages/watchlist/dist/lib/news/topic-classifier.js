...
import { TOPICS, TOPIC_VERSION, canonicalizeTopics } from '@watchlist/config/topics';
 ...
 */
export function generateIdempotencyKey(article) {
 ...
 */
function buildClassificationPrompt(articles) {
    const articlesForGPT = articles.map(a => {
        ...
        return ({
            ...
            tickers: (_a = a.matchedTickers) === null || _a === void 0 ? void 0 : _a.map(t => t.symbol)
        });
    });
 ...
 */
function classifyWithGPT(articles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log(`GPT classification complete:`, {
                ...
                tokens: usage === null || usage === void 0 ? void 0 : usage.total_tokens,
                cost: (usage === null || usage === void 0 ? void 0 : usage.total_tokens)
                    ? ((usage.prompt_tokens * 0.15 + usage.completion_tokens * 0.60) / 1000000).toFixed(6)
                    : 'unknown'
            });
            return results;
        }
 ...
 */
function classifyWithRetry(articles) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield classifyWithGPT(articles);
        // Single retry on failure
        if (result === null && articles.length > 0) {
            console.log('Retrying GPT classification...');
            result = yield classifyWithGPT(articles);
        }
        return result;
    });
}
 ...
 */
export function classifyArticles(articles_1) {
    return __awaiter(this, arguments, void 0, function* (articles, batchSize = 25) {
        const results = [];
        // Process in batches
        for (let i = 0; i < articles.length; i += batchSize) {
            ...
            const gptResults = yield classifyWithRetry(batch);
            ...
            for (const article of batch) {
                ...
                const gptResult = gptResults === null || gptResults === void 0 ? void 0 : gptResults.get(article.id);
                const gptTopics = (gptResult === null || gptResult === void 0 ? void 0 : gptResult.topics) || [];
                const scope = gptResult === null || gptResult === void 0 ? void 0 : gptResult.scope;
                const macroEventType = gptResult === null || gptResult === void 0 ? void 0 : gptResult.macroEventType;
                ...
                if (!allTopics.includes(feedTopic)) {
                    allTopics.push(feedTopic);
                }
                ...
                results.push(Object.assign(Object.assign({}, article), { topics: finalTopics, topicsClassified: gptResults !== null, classificationMetadata: metadata, scope: scope, macroEventType: macroEventType // Store macroEventType if available
                 }));
            }
        }
        return results;
 ...
 */
export function getFallbackTopics(article) {
    // Try feed topic first
    if (article.feedTopic) {
        return [article.feedTopic];
    }
    // Try RSS categories
 ...
 */
export function mergeTopics(feedTopic, gptTopics) {
