...
/**
 * Browser- and Node-compatible synchronous SHA-256 for small canonical payloads.
 * Keeping this synchronous lets newsletter readiness use the same tamper check in
 * client components and publication code without importing Node's crypto module.
 */
export function sha256Hex(value: string): string {
  ...
  messageView.setUint32(paddedLength - 4, (bytes.length * 8) >>> 0)
