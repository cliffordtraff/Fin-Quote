...
export const EDITORIAL_TEMPLATES: EditorialChartTemplate[] = [
  {
    ...
    quarterlyYearRange: { kind: 'last_n_years', n: 3 },
    supportedPeriods: ['annual', 'quarterly'],
    ...
    subtitlePattern: '{periodLabel} figures in USD',
    defaultColors: {
      revenue: '#3d4a30',
      net_income: '#b8c4a0',
    },
  },
  {
    ...
    subtitlePattern: '{periodLabel} free cash flow in USD',
    defaultColors: {
  ...
  },
  {
    ...
    subtitlePattern: '{periodLabel} gross margin as a percentage of revenue',
    defaultColors: {
      gross_margin: '#5a6b4a',
    },
  },
  {
    ...
    subtitlePattern: '{periodLabel} operating margin percentage',
    defaultColors: {
  ...
  },
  {
    ...
    subtitlePattern: '{periodLabel} revenue (bars) with closing price overlay (line)',
    defaultColors: {
      revenue: '#5a6b4a',
    },
  },
  {
    ...
    subtitlePattern: '{periodLabel} diluted EPS in USD',
    defaultColors: {
      eps: '#3d4a30',
    },
  },
  {
    ...
    subtitlePattern: '{periodLabel} total liabilities / shareholders\' equity',
    defaultColors: {
  ...
  },
  {
    ...
    subtitlePattern: '{periodLabel} R&D expenditure as a percentage of total revenue',
    defaultColors: {
  ...
  },
  {
    ...
    subtitlePattern: '{periodLabel} margin percentages — the gap reveals operating cost structure',
    defaultColors: {
      gross_margin: '#5a6b4a',
  ...
  },
  {
    ...
    subtitlePattern: '{periodLabel} figures in USD — divergence reveals earnings quality',
    defaultColors: {
      net_income: '#3d4a30',
  ...
  },
  {
    id: 'price_trend_6m',
    mode: 'price',
    label: '6-Month Price Trend',
    description:
      'Daily candlestick chart of the last six months of price action.',
    whenToUse:
      'Use when the stock is in a clear breakout, breakdown, or trend acceleration and the market action itself is the story.',
    range: '6m',
    interval: 'D',
    chartType: 'candles',
    titlePattern: '{ticker} Price Trend (6M)',
    subtitlePattern: 'Daily candlesticks over the last 6 months',
  },
  {
    id: 'price_reaction_1m',
    mode: 'price',
    label: '1-Month Price Reaction',
    description:
      'Daily candlestick chart focused on the last month of trading action.',
    whenToUse:
      'Use when the newsletter is reacting to a recent catalyst like earnings, guidance, or a sharp momentum reversal.',
    range: '1m',
    interval: 'D',
    chartType: 'candles',
    titlePattern: '{ticker} Price Reaction (1M)',
    subtitlePattern: 'Daily candlesticks over the last month',
  },
  {
    id: 'price_trend_1y',
    mode: 'price',
    label: '1-Year Price Trend',
    description:
      'One-year candlestick chart for longer rerating and level-setting stories.',
    whenToUse:
      'Use when the stock has been repriced over multiple quarters and the big-picture trend matters more than daily candle detail.',
    range: '1y',
    interval: 'D',
    chartType: 'candles',
    titlePattern: '{ticker} Price Trend (1Y)',
    subtitlePattern: 'Daily candlesticks over the last 12 months',
  },
]
