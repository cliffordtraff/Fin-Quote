export default function FeatureHighlights() {
  return (
    <section className="bg-cream-50 dark:bg-[rgb(22,22,22)] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6 space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Card */}
            <div className="bg-white dark:bg-[rgb(35,35,35)] rounded-2xl shadow-lg dark:shadow-2xl dark:shadow-black/30 p-6 relative z-10">
              <div className="mb-4">
                <p className="text-xs text-gray-500 dark:text-gray-500">Market Overview</p>
                <div className="flex items-baseline gap-2 mt-1">
                  <span className="text-xl font-semibold text-gray-900 dark:text-white">$12,650.27</span>
                  ...
                  <div key={i} className="flex items-center justify-between py-2 border-b border-gray-50 dark:border-gray-800 last:border-0">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                        <span className="text-xs text-gray-500 dark:text-gray-400">{item.name[0]}</span>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{item.name}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-500">Index</p>
                      </div>
                    </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 relative">
            {/* Card */}
            <div className="bg-white dark:bg-[rgb(35,35,35)] rounded-2xl shadow-lg dark:shadow-2xl dark:shadow-black/30 p-6 relative z-10">
              <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">Summary</p>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    <span className="text-gray-600 dark:text-gray-400">Total Value</span>
                    <span className="text-gray-900 dark:text-white font-semibold">$24,235.67</span>
                  </div>
                  {/* Stacked Bar */}
                  <div className="h-3 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden flex">
                    <div className="bg-sage-300 dark:bg-sage-600 h-full" style={{ width: '30%' }} />
                    <div className="bg-sage-500 dark:bg-sage-400 h-full" style={{ width: '70%' }} />
                  </div>
                </div>

                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-sage-300 dark:bg-sage-600" />
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-sage-500 dark:bg-sage-400" />
                ...
                <button className="w-full bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  View Statements
                </button>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Card */}
            <div className="bg-white dark:bg-[rgb(35,35,35)] rounded-2xl shadow-lg dark:shadow-2xl dark:shadow-black/30 p-6 relative z-10">
              <p className="text-xs text-gray-500 dark:text-gray-500 mb-2">Portfolio Value</p>
                ...
                <svg className="w-full h-full" viewBox="0 0 300 100" preserveAspectRatio="none">
                  <defs>
                    <linearGradient id="areaGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" className="[stop-color:#5a6b4a] dark:[stop-color:#7ab08a]" stopOpacity="0.3" />
                      <stop offset="100%" className="[stop-color:#5a6b4a] dark:[stop-color:#7ab08a]" stopOpacity="0" />
                    </linearGradient>
                  </defs>
                  <path
                  ...
                  <path
                    ...
                    fill="none"
                    className="stroke-[#5a6b4a] dark:stroke-[#7ab08a]"
                    strokeWidth="2"
                  />
                </svg>
              </div>
