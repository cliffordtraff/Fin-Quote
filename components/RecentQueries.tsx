  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Queries</h2>
        {queries.length > 0 && (
          <button
            onClick={handleClearHistory}
            disabled={clearing}
            className="text-base text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors disabled:opacity-50"
            title="Clear history"
          >
      ...
      <div className="flex-1 overflow-y-auto">
        {queries.length === 0 ? (
          <div className="px-4 py-8 text-center">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">No recent queries</p>
            <p className="text-base text-gray-400 dark:text-gray-500 mt-1">Your questions will appear here</p>
          </div>
        ) : (
            ...
            {queries.map((query) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <p className="text-lg text-gray-900 dark:text-gray-100 font-medium line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {truncateText(query.question, 100)}
                  </p>
                  <span className="text-base text-gray-400 dark:text-gray-500 whitespace-nowrap flex-shrink-0">
